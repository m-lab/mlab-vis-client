...
export const helpTipContent = {
  'transit-compare-tip': 'Transit ISPs serve to support the backbone of the Internet. '
                       + 'Client ISPs send traffic to Transit ISPs to be routed worldwide. '
                       + 'MLab servers are located within Transit ISP switching stations.',
  'client-isp-tip': 'Add or remove ISPs to compare. '
                  + 'ISP names come from volunteer process of mapping ASNs to names and so '
                  + 'are at times confusingly inconsistent with actual ISP names. '
                  + 'Multiple ASNs can be owned by a single ISP and so near duplicate names can appear.',
  ...
  'fixed-metric-tip': 'Shows a histogram of metric data broken up into evenly spaced bins. '
                    + 'Each bar shows percent of total tests that fall into that bin.',
  'facet-tip': 'Toggle what to aggregate data by.',
  'incident-isp-tip': 'An incident is a sustained 30% or more decrease in median download speed',
};
