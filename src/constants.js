...
export const metrics = [
  {
    ...
    countBinKey: 'download_speed_mpbs_bins',
    percentBinKey: 'download_speed_mpbs_percent_bins',
  ...
  },
  {
    ...
    countBinKey: 'upload_speed_mpbs_bins',
    percentBinKey: 'upload_speed_mpbs_percent_bins',
    formatter: d3.format('.1f'),
  },
  {
    value: 'rtt',
